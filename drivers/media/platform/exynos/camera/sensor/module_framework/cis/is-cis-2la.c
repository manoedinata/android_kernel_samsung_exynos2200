...
int sensor_2la_cis_log_status(struct v4l2_subdev *subdev)
{
	...
	sensor_cis_log_status(cis, client, log_2la,
	...
	const struct i2c_device_id *id)
{
	...
	if (mclk_freq_khz == 19200) {
		...
		cis->mipi_sensor_mode = sensor_2la_setfile_A_19p2_mipi_sensor_mode;
		cis->mipi_sensor_mode_size = ARRAY_SIZE(sensor_2la_setfile_A_19p2_mipi_sensor_mode);
